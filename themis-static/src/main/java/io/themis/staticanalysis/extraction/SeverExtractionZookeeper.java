...
import cn.ac.ios.bridge.entity.ZookeeperAdapter;
...
public class SeverExtractionZookeeper {
    public static CallGraph cg;

    public static final Adapter adapter = (Adapter)new ZookeeperAdapter();
    ...
    public static void main(String[] args) throws IOException, XPathExpressionException, ParserConfigurationException, SAXException {
        // Start Soot
        String systemName = "zookeeper_3.9.3";
    ...
    public static void instancePairs() {
        ...
        for (String impl : impls) {
            ...
            for (SameAccessSite sameAccessSite : sameClsVarAccessSites) {
                types.add(sameAccessSite.sameAccessClsVar.getType().toString());
            }
        }
